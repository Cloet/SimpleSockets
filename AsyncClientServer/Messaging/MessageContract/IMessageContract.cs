...
namespace AsyncClientServer.Messaging.MessageContract
{
	...
	public interface IMessageContract
	{
		...
		/// </summary>
		event Action<AsyncSocket,int, object, string> OnMessageReceived;
		...
		void RaiseOnMessageReceived(AsyncSocket socket,int clientId, object message, string header);
	}
}
